...
export function parseRegistrationPaste(text) {
  ...
  const block = registrationBlock(text);
  result.hasRegistrationBlock = block.found;
  let active = "";
