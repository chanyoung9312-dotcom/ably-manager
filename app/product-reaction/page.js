...
export default function Reactions() {
  ...
  return (
    <main className="reaction-page">
      ...
      <style jsx>{`
        .reaction-page{max-width:1080px;margin:auto;padding:26px 18px 70px;color:inherit}.page-head{display:flex;justify-content:space-between;align-items:flex-start;gap:18px;flex-wrap:wrap}.page-head small,.page-head p{color:#aeb5b8}.page-head h1{font-size:34px;margin:5px 0}.page-head p{margin:0;max-width:720px}.page-head button{padding:11px 16px;border-radius:12px}.summary-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin:24px 0 14px}.summary-grid div{border:1px solid #343a3d;border-radius:16px;padding:17px;background:#191d1f;display:flex;flex-direction:column;gap:5px}.summary-grid span{font-weight:800}.summary-grid b{font-size:25px}.summary-grid small{color:#aeb5b8}.filters{display:flex;gap:8px;overflow-x:auto;padding:3px 0 12px}.filters button{white-space:nowrap;background:#22282a;border:1px solid #343a3d;color:inherit}.filters button.active{background:#f3f4f6;color:#16191b;border-color:#f3f4f6}.product-list{border:1px solid #343a3d;border-radius:18px;background:#191d1f;padding:18px}.list-head{display:flex;justify-content:space-between;align-items:center;padding:2px 2px 14px;border-bottom:1px solid #303638}.list-head h2{margin:0;font-size:21px}.list-head span{font-weight:800}.product-card{padding:20px 2px;border-bottom:1px solid #303638}.product-card:last-child{border-bottom:0}.card-head{display:flex;justify-content:space-between;gap:14px;align-items:flex-start}.card-head small{color:#929b9f}.card-head h3{margin:5px 0 0;font-size:18px;line-height:1.45}.badges{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.badges span{border-radius:999px;padding:6px 9px;font-size:12px;font-weight:800;white-space:nowrap}.decision.buy{background:#294936}.decision.watch{background:#4a4025}.decision.stop{background:#493032}.trend{background:#252b2d;color:#c5cbce}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin:16px 0}.metrics>div{background:#22282a;border-radius:12px;padding:12px;display:flex;flex-direction:column;gap:3px}.metrics span,.metrics small{color:#aeb5b8;font-size:12px}.metrics b{font-size:19px}.status-box,.todo-box{border-radius:13px;padding:14px 15px;margin-top:9px}.status-box{background:#202527}.todo-box{background:#171b1c;border:1px solid #303638}.status-box p,.todo-box p{margin:6px 0 0;color:#c2c8ca}.todo-box ul,.all-checks ul{margin:8px 0 0;padding-left:20px}.todo-box li,.all-checks li{margin:4px 0;line-height:1.5}.product-card details{margin-top:12px}.product-card summary,.data-warning summary{cursor:pointer;font-weight:800}.detail-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:12px}.detail-grid p{margin:0;padding:11px;border-radius:11px;background:#22282a;display:flex;flex-direction:column;gap:3px}.detail-grid span{font-size:12px;color:#aeb5b8}.all-checks{margin-top:12px;padding:12px;border-radius:11px;background:#202527}.data-warning{margin-top:14px;border:1px solid #343a3d;border-radius:14px;padding:14px 16px;color:#aeb5b8}.empty{color:#aeb5b8;padding:16px 2px;margin:0}@media(max-width:760px){.summary-grid{grid-template-columns:1fr 1fr}.metrics{grid-template-columns:1fr 1fr}.card-head{flex-direction:column}.badges{justify-content:flex-start}.detail-grid{grid-template-columns:1fr 1fr}.page-head h1{font-size:28px}.product-list{padding:15px}}@media(max-width:440px){.summary-grid{grid-template-columns:1fr 1fr}.summary-grid div{padding:14px}.metrics>div{padding:10px}.metrics b{font-size:17px}.detail-grid{grid-template-columns:1fr}}
      `}</style>
    </main>
  );
}
