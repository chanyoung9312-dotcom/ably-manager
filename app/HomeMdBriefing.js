...
function PriorityItem({p}){
  return <article className="priority-item">
    ...
    <div className="priority-facts">
      <span><small>7일 판매</small><b>{p.q7||0}개</b></span>
      <span><small>30일 판매</small><b>{p.q30||0}개</b></span>
      <span><small>최근 주문</small><b>{p.last||"확인 필요"}</b></span>
    </div>
    <div className="priority-note"><span>왜 보나요?</span><p>{reasonFor(p)}</p></div>
