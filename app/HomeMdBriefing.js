...
function PriorityItem({p}){
  return <article className="priority-item">
    <div className="priority-top">
      ...
      <a className="priority-link" href="/analysis">상세 보기 →</a>
    </div>
