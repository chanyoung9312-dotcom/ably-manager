...
export default function TodayHomeNav() {
  ...
  return (
    <nav className="oars-nav" aria-label="OARS 주요 메뉴">
      ...
      <style jsx>{`
        .oars-nav{position:sticky;top:0;z-index:50;background:#15191b;border-bottom:1px solid #303638;color:#f7f7f7}.oars-nav-inner{max-width:1180px;margin:auto;min-height:58px;padding:0 18px;display:flex;align-items:center;gap:10px}.oars-home{border:1px solid #3b4447;background:#202628;color:inherit;padding:8px 11px;border-radius:10px;font:inherit;font-weight:800;cursor:pointer;white-space:nowrap}.oars-home:hover{background:#30383b}.oars-brand{font-size:18px;cursor:pointer;margin-right:6px;white-space:nowrap}.oars-main-tabs{display:flex;align-items:center;gap:4px;flex:1;overflow-x:auto;scrollbar-width:none}.oars-main-tabs::-webkit-scrollbar{display:none}.oars-main-tabs button{border:0;background:transparent;color:inherit;padding:10px 11px;border-radius:10px;font:inherit;font-weight:700;cursor:pointer;white-space:nowrap}.oars-main-tabs button:hover,.oars-main-tabs button.active{background:#252b2e}@media(max-width:720px){.oars-nav-inner{padding:0 8px;gap:5px}.oars-home{padding:8px 9px;font-size:13px}.oars-brand{display:none}.oars-main-tabs button{padding:9px 9px;font-size:13px}}
      `}</style>
      <style jsx global>{`
